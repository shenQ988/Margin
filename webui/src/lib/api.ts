...
export interface WeReadAdvisorBook {
  bookId: string;
  title: string;
  author: string | null;
  category: string | null;
...
export interface WeReadAdvisorPayload {
  configured: boolean;
  deepReads: WeReadAdvisorBook[];
  dormantBooks: WeReadAdvisorBook[];
  activeBooks: WeReadAdvisorBook[];
